...
public class FilesContentReplace {
    ...
    public static void main(String[] args) {
        ...
        try {
            File pureStringConfig = new File("java/src/filescontentreplace/pureStringConfig.txt");
    ...
    public static String[][] getConfigStringArray() throws IOException {
        ...
        File regexConfig = new File("java/src/filescontentreplace/regexConfig.txt");
