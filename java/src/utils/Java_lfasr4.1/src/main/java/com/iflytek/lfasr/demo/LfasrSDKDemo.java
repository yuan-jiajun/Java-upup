...
public class LfasrSDKDemo {
    private static final String APP_ID = "5fe964d0";
    private static final String SECRET_KEY = "7a53394aa0181e0d0dbdae80a790258b";
...
//    private static final String AUDIO_FILE_PATH = LfasrSDKDemo.class.getResource("/").getPath()+"/audio/lfasr.wav";
    private static final String AUDIO_FILE_PATH = "F:\\modules\\毕业相关\\交流&汇报录音\\基于mapreduce的终端安全合规检测.m4a";

    private static final String OUTPUT_JSON_FILE_PATH = AUDIO_FILE_PATH + ".lfasr.json";
...
//        System.out.println("转写结果: \n" + result.getData());
        ...
        File resultFile = new File(OUTPUT_JSON_FILE_PATH);
        FileInputOutput.stringToFile(dealJson(result.getData()), resultFile);

        //退出程序，关闭线程资源，仅在测试main方法时使用。
        System.exit(0);
    }

    public static String dealJson(String rawJson) {
        JSONArray jsonArray = JSONArray.parseArray(rawJson);
